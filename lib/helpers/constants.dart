...
const loremIpsum =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In hendrerit mollis maximus. Praesent neque libero, faucibus at eros at, facilisis auctor est. Nulla ac odio eros. Morbi quis condimentum purus. Donec euismod odio a rhoncus scelerisque. Proin a ante velit. Vestibulum eleifend ante at lectus molestie, feugiat lacinia odio pharetra.";
...
var facts = [
  ...
  'When mice live in the wild, they typically only live for about six months due to the fact that they have so many predators. However, in a controlled environment like being kept as a pet, they can live up to two years.',
